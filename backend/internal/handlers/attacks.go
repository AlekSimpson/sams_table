...
func New_AttackHandler(pool *pgxpool.Pool, webtoken_service *auth.JWTService) *AttackHandler {
	return &AttackHandler{database_pool: pool, webtoken_service: webtoken_service}
}

func (self *AttackHandler) List_Attacks(response_writer http.ResponseWriter, request *http.Request) {
...
func (self *AttackHandler) Get_Attack(response_writer http.ResponseWriter, request *http.Request) {
